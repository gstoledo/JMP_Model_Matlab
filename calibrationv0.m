...
% grid_cost_d=linspace(0.5,2,10);
% grid_cost_p=linspace(0.5,2,10);
...
% if location=="hpc"
%     save('/home/gst247/HPC_Model_Matlab/Calibration_outcomes/calibrationv0.mat','distances','moments','combinations','dm')
% end
...
save('calibrationv0_costs_qup.mat','distances','moments','combinations','dm')
if location=="hpc"
    save('/home/gst247/HPC_Model_Matlab/Calibration_outcomes/calibrationv0_costs_qup.mat','distances','moments','combinations','dm')
end
