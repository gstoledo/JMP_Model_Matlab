...
%% Specification 6
%Sp3 but only one type of firm a
ats=1;
a_trans=1;
...
eplus_edist=(n/n_types)*ones(1,ats);
eplus_mdist=(n/n_types)*ones(ats,tpts);
eplus_ndist=(n/n_types)*ones(ats,tpts);
eplus_tdist=(n/n_types)*ones(ats,tpts,tpts);
...
%         fprintf('Sp6 Joint Converged in %d iterations\n',it_joint)
%     end
...
save('model_solutions_sp6'+location,'Ve','Vm','Vn','Vt','U','Veh','Vmh','Vnh','Vth','eplus_udist','eplus_edist','eplus_mdist','eplus_ndist','eplus_tdist','nplus','popplus');
