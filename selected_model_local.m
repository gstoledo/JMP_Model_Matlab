...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Load here the solution
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% load('Param_selec/param_selectionSTD_Lunch.mat')
...
for ztilde=1:3:tpts
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %         {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_u.png');  
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_m.png');
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_nm.png');
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_t_m_q1.png');
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_t_m_q2.png');
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_t_m_q3.png');
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_t_nm_q1.png');
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_t_nm_q2.png');
    ...
    %     'Worker Type', 'Manager Type', 20, {'d', 's', 'd', 'd', 's', 's'}, {dkbluecbp1,dkorangecbp1,greencbp1,greycbp1,pinkcbp1,blackcbp1},...
    %     {'Hire as M', 'Hire as NM', 'Hire as M w/ fire', 'Hire as M w/ demotion','Hire as NM w/ fire', 'Hire as NM w/ promotion'},...
    %     '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Alloc'+string(ztilde)+'_t_nm_q3.png');
...
%         'Worker Type', 'Manager Type', 16,markers,colors, ...
%         {'Fire M', 'Fire NM', 'Demote M', 'Promote NM','Fire M w/ promotion', 'Fire NM w/ demotion','Reallocate both','Fire both'},...
%         '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Reallocation_a'+string(a)+'.png');
% end
...
titles={'a=1',...hh
    ...
    plot_realloc_matcombine(R_matrices, titles,'','Worker Type', 'Manager Type', 20,markers,colors,...
    {'Fire M', 'Fire NM', 'Demote M', 'Promote NM','Fire M w/ promotion', 'Fire NM w/ demotion','Reallocate both','Fire both'},...
    '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/Reallocation_all.png');
...
heatmap_combined(E,1,bluepurplePalette_rgb, ats,tpts, '' , 'Worker type', 'Manager type', '/Users/gabrieltoledo/Library/CloudStorage/GoogleDrive-gabrielstoledo.gt@gmail.com/My Drive/PHD NYU/Labor Firm Structure/Latex/Presentations/Figures/Fall_STD_Lunch/dist_cond_a.png');
