...
function [e1_udist,e1_edist,e1_mdist,e1_ndist,e1_tdist]=e1_dist(Veh,Vmh,Vnh,Uh,Vth,ats,tpts,cost_d,cost_p,e_udist,e_edist,e_mdist,e_ndist,e_tdist,lamu,lam,n,del,steal)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %Policy functions
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if steal==1
        ...
        n1=sum(e1_edist)+sum(e1_mdist,"all")+sum(e1_ndist,"all")+sum(e1_tdist,"all"); 
        e1_edist(1)=e1_edist(1)+(n-n1);
        e1_udist(1)=e1_udist(1)+(pop0-pop1);
    end
