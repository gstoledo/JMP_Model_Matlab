function graphs_selected_model(p,ps,v,e,w,job_name)
    ...
    for ztilde=1:3:7
        ...
        %        events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_u.png'));  
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_m.png'));
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_nm.png'));
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_t_m_q1.png'));
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_t_m_q2.png'));
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_t_m_q3.png'));
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_t_nm_q1.png'));
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_t_nm_q2.png'));
        ...
        %     'Worker Type', 'Manager Type', 20,markers_alloc, colors_alloc,...
        %    events_alloc,...
        %     fullfile(hpc_path,'Alloc'+string(ztilde)+'_t_nm_q3.png'));
            ...
            events_alloc,...
                fullfile(hpc_path,'Alloc_z'+string(ztilde)+'_all.png'));
    end
    ...
    for a=1:ats
        ...
        %     fullfile(hpc_path,'Reallocation_a'+string(a)+'.png'));
    end
    ...
    titles={'a=1',...
        ...
        fullfile(hpc_path,'Reallocation_all.png'));
    ...
    heatmap_combined(E,1,bluepurplePalette_rgb, ats,tpts, '' , 'Worker type', 'Manager type',  fullfile(hpc_path,'dist_cond_a.png'));
