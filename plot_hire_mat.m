function plot_hire_mat(H_u, titleText, xlabelText, ylabelText, fontSize, markerShape, markerColor, filename)
    % plot_binary_matrix: Function to plot a binary matrix with customizable options
    %
    % Inputs:
