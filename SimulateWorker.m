...
function [worker_status,self_z,co_z,a_wtp,self_wage,co_wage,self_age,self_tenure,co_tenure,hire_m,hire_n,fire_m,fire_n,prom_sm,prom_realloc,fire_m_realloc,fire_n_realloc]=SimulateWorker(n_months,n_workers,seed,ats,tpts,param,v,d,w,fs)
