...
function fs=SimulateFirm_cl_NCC(p,ps,tg,sp,v,d,w)
    ...
    r.free_m=rand(n_months,n_firms); %Free is manager to be Hired
    r.free_n=rand(n_months,n_firms); %Free is non manager to be Hired
               ...
               % Does it match someone?
                if (r.event(t,i)<prob_matching)
                    ...
                    %Match with team
                        ...
                        elseif (r.free_m(t,i)<=phim && r.free_n(t,i)>phin) %Manager is free
                            % Hire the manager?
                            if (h_e_t_m_Lnm(at,zt,nt,a_ftp(t,i))>0)
                                %Where does it go?
                                if (p_e_m(a_ftp(t,i),zt)>0) %Put as manager
                                    firm_status(t,i)=2;
                                    hire_m(t,i)=1;
                        ...
                        elseif (r.free_m(t,i)>phim && r.free_n(t,i)<=phin) %Non manager is free
                            % Hire the non manager?
                            if (h_e_t_nm_Lm(at,zt,nt,a_ftp(t,i))>0)
                                if (p_e_m(a_ftp(t,i),nt)>0) %Put as manager
                                    firm_status(t,i)=2;
                                    hire_m(t,i)=1;
                                    m_ftp(t,i)=nt;
            ...
            if (firm_status(t-1,i)==2) %Firm with manager
                ...
                elseif (r.event(t,i)> del+death && r.event(t,i)<= del+death+prob_matching) %Match with someone
                    ...
                    %Match with team
                        ...
                        elseif (r.free_m(t,i)<=phim && r.free_n(t,i)>phin) %Manager is free
                            %Hire the manager?
                            if (h_m_t_m_Lnm(at,zt,nt,a_ftp(t,i),m_ftp(t,i))>0)
                                %Where does it go?
                                if (p_m_m_u(a_ftp(t,i),m_ftp(t-1,i),zt)>0) %Put as manager firing current
                                    firm_status(t,i)=2;
                                    hire_m(t,i)=1;
                        ...
                        elseif (r.free_m(t,i)>phim && r.free_n(t,i)<=phin) %Non manager is free
                            %Hire the non manager?
                            if (h_m_t_nm_Lm(at,zt,nt,a_ftp(t,i),m_ftp(t,i))>0)
                                %Where does it go?
                                if (p_m_m_u(a_ftp(t,i),m_ftp(t-1,i),nt)>0) %Put as manager firing current
                                    firm_status(t,i)=2;
                                    hire_m(t,i)=1;
                ...
                elseif (r.event(t,i)> del+death && r.event(t,i)<= del+death+prob_matching) %Match with someone
                    ...
                    %Match with team
                        ...
                        elseif (r.free_m(t,i)<=phim && r.free_n(t,i)>phin)
                            % Hire the manager?
                            if (h_nm_t_m_Lnm(at,zt,nt,a_ftp(t,i),n_ftp(t,i))>0)
                                %Where does it go?
                                if (p_n_n_u(a_ftp(t,i),n_ftp(t,i),zt)>0) %Put as non manager firing current
                                    firm_status(t,i)=3;
                                    hire_n(t,i)=1;
                        ...
                        %Non manager is free but manager is not
                        elseif (r.free_m(t,i)>phim && r.free_n(t,i)<=phin)
                            % Hire the non manager?
                            if (h_nm_t_nm_Lm(at,zt,nt,a_ftp(t,i),n_ftp(t,i))>0)
                                %Where does it go?
                                if (p_n_n_u(a_ftp(t,i),n_ftp(t,i),nt)>0) %Put as non manager firing current
                                    firm_status(t,i)=3;
                                    hire_n(t,i)=1;
            ...
            if (firm_status(t-1,i)==4) %Firm with team
                ...
                elseif (r.event(t,i)> del+death+del+death && r.event(t,i)<= del+death+del+death+prob_matching) %Match with someone
                    ...
                    %Match with team
                        ...
                        elseif (r.free_m(t,i)<=phim && r.free_n(t,i)>phin)
                            % Hire the manager?
                            if (h_t_t_m_Lnm(at,zt,nt,a_ftp(t,i),m_ftp(t,i),n_ftp(t,i))>0)
                                %Where does it go?
                                if (p_t_m_u(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),zt)>0) %Put as manager firing current
                                    firm_status(t,i)=4;
                                    hire_m(t,i)=1;
                        ...
                        elseif (r.free_m(t,i)>phim && r.free_n(t,i)<=phin)
                            %Hire the non-manager?                          
                            if (h_t_t_nm_Lm(at,zt,nt,a_ftp(t,i),m_ftp(t,i),n_ftp(t,i))>0)
                                %Where does it go?                                
                                if (p_t_m_u(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),nt)>0) %Put as manager firing current
                                    firm_status(t,i)=4;
                                    hire_m(t,i)=1;
                ...
                elseif (r.event(t,i)>del+death+prob_matching && r.event(t,i)<=del+death+prob_matching+ lam) % Firm is met by another
                    ...
                    elseif (r.free_m(t,i)<=phim && r.free_n(t,i)>phin)
                        if (r.event(t,i)<cdf_firm_dist(1)) %Met By vacant firm
                            av=draw_CDF_1d(cdf_e_edist,r.type(t,i));
                            %Does the poacher hire the manager?
                            if (h_e_t_m_Lnm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),av)>0)                                
                                firm_status(t,i)=3; %becomes a firm with non manager
                                m_ftp(t,i)=0;
                                m_fwage(t,i)=0.0;
                                n_fwage(t,i)=n_fwage(t-1,i);
                        ...
                        elseif (r.event(t,i)>=cdf_firm_dist(1) && r.event(t,i)<cdf_firm_dist(2)) %Met by firm with manager
                            [am,zm]=draw_CDF_2d(cdf_e_mdist,ats,tpts,r.type(t,i));
                            %Does the poacher hire the manager?
                            if (h_m_t_m_Lnm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),am,zm)>0)
                                firm_status(t,i)=3; %becomes a firm with non manager
                                m_ftp(t,i)=0;
                                m_fwage(t,i)=0.0;
                                n_fwage(t,i)=n_fwage(t-1,i);
                        ...
                        elseif (r.event(t,i)>=cdf_firm_dist(2) && r.event(t,i)<cdf_firm_dist(3)) %Met by firm with non manager
                            [an,zn]=draw_CDF_2d(cdf_e_ndist,ats,tpts,r.type(t,i));
                            %Does the poacher hire the manager?
                            if (h_nm_t_m_Lnm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),an,zn)>0)
                                firm_status(t,i)=3; %becomes a firm with non manager
                                m_ftp(t,i)=0;
                                m_fwage(t,i)=0.0;
                                n_fwage(t,i)=n_fwage(t-1,i);
                            ...
                            [at,zt,nt]=draw_CDF_3d(cdf_e_tdist,ats,tpts,r.type(t,i));
                            %Does the poacher hire the manager?
                            if (h_t_t_m_Lnm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),at,zt,nt)>0)
                                firm_status(t,i)=3; %becomes a firm with non manager
                                m_ftp(t,i)=0;
                                m_fwage(t,i)=0.0;
                                n_fwage(t,i)=n_fwage(t-1,i);
                    ...
                    elseif (r.free_m(t,i)>phim && r.free_n(t,i)<=phin)
                        if (r.event(t,i)<cdf_firm_dist(1)) %Met By vacant firm
                            av=draw_CDF_1d(cdf_e_edist,r.type(t,i));
                            %Does the poacher hire the non manager?    
                            if (h_e_t_nm_Lm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),av)>0)
                                firm_status(t,i)=2; %becomes a firm with manager
                                n_ftp(t,i)=0;
                                n_fwage(t,i)=0.0;
                                m_fwage(t,i)=m_fwage(t-1,i);
                        ...
                        elseif (r.event(t,i)>=cdf_firm_dist(1) && r.event(t,i)<cdf_firm_dist(2)) %Met by firm with manager
                            [am,zm]=draw_CDF_2d(cdf_e_mdist,ats,tpts,r.type(t,i));
                            %Does the poacher hire the non manager?    
                            if (h_m_t_nm_Lm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),am,zm)>0)
                                firm_status(t,i)=2; %becomes a firm with manager
                                n_ftp(t,i)=0;
                                n_fwage(t,i)=0.0;
                                m_fwage(t,i)=m_fwage(t-1,i);
                        ...
                        elseif (r.event(t,i)>=cdf_firm_dist(2) && r.event(t,i)<cdf_firm_dist(3)) %Met by firm with non manager
                            [an,zn]=draw_CDF_2d(cdf_e_ndist,ats,tpts,r.type(t,i));
                            %Does the poacher hire the non manager?    
                            if (h_nm_t_nm_Lm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),an,zn)>0)
                                firm_status(t,i)=2; %becomes a firm with manager
                                n_ftp(t,i)=0;
                                n_fwage(t,i)=0.0;
                                m_fwage(t,i)=m_fwage(t-1,i);
                            ...
                            [at,zt,nt]=draw_CDF_3d(cdf_e_tdist,ats,tpts,r.type(t,i));
                            %Does the poacher hire the non manager?
                            if (h_t_t_nm_Lm(a_ftp(t,i),m_ftp(t,i),n_ftp(t,i),at,zt,nt)>0)
                                firm_status(t,i)=2; %becomes a firm with manager
                                n_ftp(t,i)=0;
                                n_fwage(t,i)=0.0;
                                m_fwage(t,i)=m_fwage(t-1,i);
